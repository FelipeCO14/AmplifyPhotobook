...
<script lang="ts">
  ...
  export default class AlbumDetailPage extends Vue {
    @Action('albumInfo/getAlbum')
    getAlbum!: (albumId: number) => any;

    @Action('albumInfo/createPhoto')
    createPhoto!: (file: any) => any;

    photos = [];
    albumName = '';
    id!: number; //computed property
